...
class ALSADriver(AudioDriverBase):
    ...
    def enumerate_devices(self) -> List[AudioDeviceInfo]:
        """Enumerate ALSA devices and detect running audio applications"""
        devices = []
        ...
        try:
            try:
                ...
                try:
                    ...
                    if audio_apps:
                        logger.info(f"Detected {len(audio_apps)} audio applications via ALSA")
